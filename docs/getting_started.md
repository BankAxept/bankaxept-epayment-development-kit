...
sequenceDiagram
    ...
    IntegratorRepresentative ->> ePaymentRepresentative: Provide set of IPs, Authentication Provider, CallbackUrl,<br/>and public signing certificate when applicable.
...
| CallbackUrl                          | Yes      | Defined by Integrator, will be the prefix address all Callback requests are sent. Peruse our [Callback](#Asynchronous-retry-policy) section for more context. |
